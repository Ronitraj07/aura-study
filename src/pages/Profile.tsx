...
export default function Profile() {
  ...
  const STAT_CARDS = [
    { id: "ppts",        label: "PPTs Created",    value: stats?.ppts_count          ?? 0, icon: Presentation, bg: "rgba(139,92,246,0.12)",  border: "rgba(139,92,246,0.25)",  gc: "hsl(262,80%,60%), hsl(220,85%,60%)" },
    { id: "assignments", label: "Assignments",      value: stats?.assignments_count   ?? 0, icon: FileText,     bg: "rgba(59,130,246,0.12)",   border: "rgba(59,130,246,0.25)",   gc: "hsl(217,91%,60%), hsl(189,94%,53%)" },
    { id: "notes",       label: "Notes Created",    value: stats?.notes_count         ?? 0, icon: BookOpen,     bg: "rgba(16,185,129,0.12)",   border: "rgba(16,185,129,0.25)",   gc: "hsl(160,84%,39%), hsl(174,62%,47%)" },
    ...
    { id: "tasks",       label: "Tasks Completed",  value: stats?.checklist_count     ?? 0, icon: CheckSquare,  bg: "rgba(249,115,22,0.12)",   border: "rgba(249,115,22,0.25)",   gc: "hsl(25,95%,53%), hsl(330,85%,60%)" },
  ];
